            ...
            <div class="col-lg-10">
                <form action="articleCreate.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="dropdown">                            
                            <?php 
                                ...
                                $id="";
                            ?>
                            <select name="game_forum" id="" class="btn btn-warning dropdown-toggle" type="button"data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="mb-2">
                        ...
                        <input class="form-control" type="text" id="article_title", name="article_title" required>
                    </div>
                    <div class="mb-2">
                        <label for="article_content">文章內容</label>
                        <textarea name="article_content" id="article_content" cols="30" rows="4" class="form-control" required></textarea> 
                    </div>
                    <form action="articleCreate.php" method="post" enctype="multipart/form-data"> 
                        <div class="mb-2">
